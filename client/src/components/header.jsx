...
export function Header() {
  return (
    <>
      <div className="bg-[#F6AD16] h-[194px] px-6 py-4">
        <div className="flex items-start gap-4">
          ...
          <div className="flex flex-col items-center px-4 py-2 bg-white rounded-xl">
            <img src={qrcodeTest} width={59} height={59} />
      ...
      <div className="px-8 py-5 flex justify-between border mx-6 bg-white relative top-[-41px] rounded-xl border-[#F6AD16]">
        ...
        <div className="flex flex-col gap-1">
          ...
          <span className="font-semibold">ARGO DRIVE 1.0</span>
        </div>
        ...
        <div className="flex flex-col gap-1">
          ...
          <span className="font-semibold">120.543</span>
        </div>
