  ...
  return (
    <div className="rounded-xl overflow-hidden shadow-sm border border-rounded">
      ...
      <div>
        ...
        <div className="grid grid-cols-3 border-b last:border-b-0">
          <div className="py-1 px-4 text-sm font-bold text-gray-700">MARCA/MODELO:</div>
        ...
        <div className="grid grid-cols-3 border-b last:border-b-0">
          <div className="py-1 px-4 text-sm font-bold text-gray-700">ANO:</div>
          <div className="py-1 px-4 text-sm text-gray-900">yearManufactureModel</div>
          <div className="py-1 px-4 text-sm text-gray-900">yearManufactureModel</div>
        </div>

        <div className="grid grid-cols-3 border-b last:border-b-0">
          <div className="py-1 px-4 text-sm font-bold text-gray-700">GRAV. DO CHASSI:</div>
          <div className="py-1 px-4 text-sm text-gray-900">chassis</div>
          <div className="py-1 px-4 text-sm text-gray-900">chassis</div>
        </div>

        <div className="grid grid-cols-3 border-b last:border-b-0">
          <div className="py-1 px-4 text-sm font-bold text-gray-700">GRAV. DO MOTOR:</div>
          <div className="py-1 px-4 text-sm text-gray-900">engineNumber</div>
          <div className="py-1 px-4 text-sm text-gray-900">engineNumber</div>
        </div>

        <div className="grid grid-cols-3 border-b last:border-b-0">
          <div className="py-1 px-4 text-sm font-bold text-gray-700">KM:</div>
          <div className="py-1 px-4 text-sm text-gray-900">km</div>
          <div className="py-1 px-4 text-sm text-gray-900">km</div>
        </div>
      </div>
    </div>
