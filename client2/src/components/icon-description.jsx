...
export function IconDescription() {
  return (
    <div className="flex flex-wrap gap-6 items-center justify-between px-8">
      <div className="flex items-center gap-2">
        <div
          className="rounded-full"
          style={{ backgroundColor: "#48BB78", padding: "0.25rem" }}
        >
      ...
      <div className="flex items-center gap-2">
        <div
          className="rounded-full"
          style={{ backgroundColor: "#3B82F6", padding: "0.25rem" }}
        >
      ...
      <div className="flex items-center gap-2">
        <div
          className="rounded-full"
          style={{ backgroundColor: "#F59E0B", padding: "0.25rem" }}
        >
      ...
      <div className="flex items-center gap-2">
        <div
          className="rounded-full"
          style={{ backgroundColor: "#EF4444", padding: "0.25rem" }}
        >
